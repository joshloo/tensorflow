...
StatusOr<Operation*> ConvertOp(
    ...
    OpBuilder builder, const std::unique_ptr<tfl::FlatBufferModel>& model_ptr) {
...
StatusOr<FuncOp> ConvertSubgraph(
    ...
    const std::unique_ptr<tfl::FlatBufferModel>& model_ptr,
...
OwningOpRef<mlir::ModuleOp> tflite::FlatBufferToMlir(
  ...
  auto model_ptr = tfl::FlatBufferModel::VerifyAndBuildFromBuffer(
